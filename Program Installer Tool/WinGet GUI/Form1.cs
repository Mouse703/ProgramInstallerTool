    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonInstallOther_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (checkBoxCineBench.Checked) { programsToInstall.Add("9PGZKJC81Q7J"); }
                ...
                if (checkBoxMessenger.Checked) { programsToInstall.Add("9WZDNCRF0083"); }
                ...
                if (checkBoxSoundswitch.Checked) { programsToInstall.Add("XP9K5QHW4KX4H8"); }
                if (checkBoxSteam.Checked) { programsToInstall.Add("Valve.Steam"); }
                if (checkBoxSurfshark.Checked) { programsToInstall.Add("XP9KN848DQPDK9"); }
